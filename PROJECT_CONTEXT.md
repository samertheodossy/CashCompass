...
| Aug 21–27 | Controlled stale/failure, Skip/Stop-tracking safety, Retirement runtime, Quick Add semantics, and Upcoming Dismiss language | Critical journeys pass with explicit consequences, recovery, preserved history, and verified cleanup |
| Aug 28–Sep 3 | Remaining page-level UX gaps; begin measured performance optimization and final fixture/recovery proof | Page contracts close or are evidence-closed without speculative redesign; candidate prerequisites advance |
