...
| Current | Rolling Financial Plan, then pre-publish product consistency/shared lifecycle | Complete the RFP core, then resume `3o` one guarded module at a time; Debt, Bank, and Investments are complete through isolated `@343`, shared fit `3p` is complete through `@341`, followed by Houses, Income, and Bills |
