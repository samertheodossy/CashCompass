...
- Canonical financial basis — Option A plus shared Central/bounded Planner/Rolling/Dashboard totals passed isolated Central `@149` run `20260722-143242-d150` 34/34 with Provisioning/Drift/Restricted/Trash PASS; audit consumers are not switched (`FINANCIAL_INTEGRITY_PHASE_3_PLAN.md`)
