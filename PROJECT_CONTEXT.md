...
**Current implementation priority (2026-07-31):** `3a`, loading-state consistency. `3c`, Planning hierarchy and Debt relationships, is complete. Bill occurrence correction (`5j`) is explicitly deferred for a later focused redesign. This priority change does not waive any Beta gate or reopen the completed `5h`/`5i` foundations.
