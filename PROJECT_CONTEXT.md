...
| Current | Pre-publish product consistency and shared lifecycle | Complete `3o` one guarded module at a time; Debt and Bank are complete through isolated `@338`, shared fit `3p` is complete through `@341`, followed by Investments, Houses, and Income |
