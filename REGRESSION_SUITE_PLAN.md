...
| Financial Integrity Option A | Pure inclusion/summary/full-snapshot checks plus shared Planner/Rolling consumer-basis checks | Expanded suite runtime PASS at isolated `@148` (`20260722-140739-190f`): 27/27, Provisioning/Drift/Restricted/Trash PASS | Retain as the prerequisite regression and rerun after each consumer-convergence slice. |
