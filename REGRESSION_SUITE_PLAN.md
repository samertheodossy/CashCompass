...
| Financial Integrity Option A | Pure inclusion/summary/full-snapshot plus shared Planner/Rolling/Dashboard consumer-basis checks | Runtime PASS at isolated `@149` (`20260722-143242-d150`): 34/34, Provisioning/Drift/Restricted/Trash PASS | Retain as the prerequisite regression and rerun after each consumer/audit convergence slice. |
