...
| **INPUT - Debts** | Operational | ★★★★★ Golden Reference | Existing Operational styling remains converged. House Financial Accuracy adds canonical final `Linked Property` schema/width/note/validation in code; isolated and approved bounded runtime proof passed. Manual Golden alignment remains separately approval-gated and was not performed. | S | P1 |
...
| **INPUT - Settings** | Analytical / Configuration | ★★★★☆ Production Ready | **✅ Converged (Validator, Special scope):** Key 240 / Value 385 widths + header `#ffe599`; typography decision ratified 2026-07-20 as 16pt header / 14pt body. First-create only; existing populated sheets are untouched. Manual Canonical-workbook alignment is non-blocking. | XS | P2 |
