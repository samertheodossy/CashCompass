...
var DATA_READINESS_COPY_ = {
  ...
  PAGE_SCOPE: 'Data Readiness checks required monthly cash and credit-card data. Monthly Review checks monthly values across banks, houses, investments, and debts.',
  ...
  ACTION_OPTIONAL: 'No action required.',
...
function buildPlanningDataReadinessModel_(ss, asOf) {
  ...
  return {
    ...
    summary: {
      ...
      pageScope: DATA_READINESS_COPY_.PAGE_SCOPE,
