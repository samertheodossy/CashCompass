...
function getHarnessScenarios_() {
  ...
  if (typeof getHarnessIncomeLifecycleScenario_ === 'function') {
    list.push(getHarnessIncomeLifecycleScenario_());
  }
  ...
  if (typeof getHarnessPart2aDataReadinessScenario_ === 'function') {
    list.push(getHarnessPart2aDataReadinessScenario_());
  }
