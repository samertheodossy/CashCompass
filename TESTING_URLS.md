...
| Isolated Central validation | https://script.google.com/macros/s/AKfycbzMaD3Ur0H3VmatL4W2vVHlYhFOXF4cZSSjIcn3SwggbTCs9Q9F1_PH74F16lAFkUlWZQ/exec | Disposable runtime-validation deployment, currently version 353. This is the only Central deployment updated during pre-release test work. RFP-3a Capital Allocation Foundation run `20260814-112123-c4fd` passed its deterministic PURE scenario and 16/16 assertions in 5.7 s, with Provisioning PASS, Drift PASS, and the marker-verified fixture verified TRASHED; the disposable runner was returned OFF. The prior Income-Producing Investment Foundation run `20260814-070625-5dbc` remains valid for its exact `@351` source. Version 352 removed redundant Add actions from House, Bank, and Investment Manage views. Central Beta remains version 106. |
