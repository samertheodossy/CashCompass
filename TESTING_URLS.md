...
| Isolated Central validation | https://script.google.com/macros/s/AKfycbzMaD3Ur0H3VmatL4W2vVHlYhFOXF4cZSSjIcn3SwggbTCs9Q9F1_PH74F16lAFkUlWZQ/exec | Disposable runtime-validation deployment, currently version 352. This is the only Central deployment updated during pre-release test work. Income-Producing Investment Foundation run `20260814-070625-5dbc` passed both integration scenarios and 40/40 assertions in 136.0 s: metadata 19/19 and activity/import 21/21, including safe exclusion of Robinhood's blank disclaimer footer while genuine undated transactions remain fail-closed. Both Restricted marker-verified fixtures passed provisioning and drift checks, were verified Trashed, and the guarded disposable runner is OFF. Version 352 removes redundant Add actions from House, Bank, and Investment Manage views; permanent Dashboard UX coverage and the full local suite pass, and the owner visually approved the common-source bounded presentation. Central Beta remains version 106. |
