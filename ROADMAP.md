...
| Current | Close `3o` product consistency and shared lifecycle one guarded module at a time: Investments → Houses → Income. Debt and Bank are complete through isolated `@338`; `3p` then commonizes dynamic name/payee-column fit. |
...
Central `@338`; migrate Investments, Houses, and Income Sources
