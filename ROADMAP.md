...
| Aug 21–27 | Close controlled stale/failure, Skip/Stop-tracking safety, Retirement runtime, Quick Add semantics, and Upcoming Dismiss language. |
| Aug 28–Sep 3 | Close remaining page-level UX gaps and begin measured performance optimization plus final fixture/recovery proof. |
