...
1. **Decision/read model and live consumers runtime-proven:** Option A plus shared Planner/Rolling/Dashboard totals passed isolated Central `@149` run `20260722-143242-d150` 34/34 with Provisioning/Drift/Restricted/Trash PASS. Audit convergence remains under `FINANCIAL_INTEGRITY_PHASE_3_PLAN.md`.
