...
**Current isolated deployment:** `@322`. The Activity-correction evidence
...
| 5 | `7a`–`7f` | Monetization-ready policy and architecture foundation; no billing activation | 5–10 d |
